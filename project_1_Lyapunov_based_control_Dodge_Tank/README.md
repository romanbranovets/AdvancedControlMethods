...
#### Figure 1 — 2D Trajectory overview
![Trajectory](figures/01_trajectory.png)

#### Figure 2 — State trajectories $x(t)$, $y(t)$, $\theta(t)$
![State trajectories](figures/02_state_trajectories.png)

#### Figure 3 — Control signals $v_L(t)$, $v_R(t)$, $v(t)$, $\omega(t)$
![Control signals](figures/03_control_signals.png)

#### Figure 4 — Lyapunov function $V(t)$ annotated by controller mode
![Lyapunov](figures/04_lyapunov.png)

#### Figure 5 — Error metrics $\rho(t)$ and $|\alpha(t)|$
![Error metrics](figures/05_error_metrics.png)

#### Figure 6 — Phase portrait $V$ vs $\rho$
![Phase portrait](figures/06_phase_portrait.png)

### Animations

#### Robot animation (field view)
[animations/robot.mp4](animations/robot.mp4)

#### Lyapunov function animation
[animations/lyapunov.mp4](animations/lyapunov.mp4)

> To regenerate all figures and animations: `python scripts/generate_report.py --seed 0`
